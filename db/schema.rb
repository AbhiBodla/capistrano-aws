...
ActiveRecord::Schema.define(version: 2022_01_25_053136) do
  ...
  create_table "specific_notifications", force: :cascade do |t|
    ...
    t.boolean "readed"
    t.datetime "discarded_at"
    t.index ["discarded_at"], name: "index_specific_notifications_on_discarded_at"
    t.index ["notification_id"], name: "index_specific_notifications_on_notification_id"
    t.index ["user_id"], name: "index_specific_notifications_on_user_id"
  end
